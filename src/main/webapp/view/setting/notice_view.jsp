...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <div class="box-right-main">
        <h2>
            <span class="glyphicon glyphicon-play" style="margin-right: 5px"></span>查看公告
        </h2>
       	<div class="tablelist">
           <div class="row bdlist">
               <div class="col-md-6">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" value="${(notice.title)!!}"  type="text" name="title" id="textfield" readonly="true"/>
