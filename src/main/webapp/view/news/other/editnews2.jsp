				...
				<div class="row bdlist">
					<div class="col-md-6">
						<div class="form-group">
							<label class="col-sm-3 control-label">所属类别<b
								style="color: red;">*</b>：
							</label>

							<div class="col-sm-9">
								<select name="typeid.id" id="typeid"
									class="selectpicker form-control"> <#list newsTypes as
									nt>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">标题<b
								style="color: red;">*</b>：
							</label>

							<div class="col-sm-9">
								<input class="form-control" type="text" name="title"
									id="textfield" value="${(news.title)!!}" /> <span
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="sort"
									id="textfield2" value="${(news.sort)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="subtitle"
									id="textfield3" value="${(news.subtitle)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<p>
									<input type="checkbox" id="plactop" name="plactop" value="0">是否置顶
								</p>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="seotitle" id="textarea2"
									cols="45" rows="2">${(news.seotitle)!!}</textarea>
								<span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="info" id="textarea"
									cols="45" rows="2">${(news.info)!!}</textarea>
								<span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="link"
									id="textfield3" value="${(news.link)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="author"
									id="textfield4" value="${(news.author)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="source"
									id="textfield5" value="${(news.source)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="label"
									id="textfield6" value="${(news.label)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="clicknumber"
									id="textfield7" value="${(news.clicknumber)!!}" /> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						...
						<div class="form-group raiseStart">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="seodes" id="textarea2"
									cols="45" rows="2">${(news.seodes)!!}</textarea>
								<span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group raiseEnd">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="seokey" id="textarea3"
									cols="45" rows="2">${(news.seokey)!!}</textarea>
								<span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
					...
					<div>
						<div>
							<textarea name="text" id="editor"
								style="width: 100%; height: 200px;">${(news.text)!!}</textarea>
						</div>
