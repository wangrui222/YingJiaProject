...
<body>
	...
	<div class="box-right-main">
		<h2>
			<span class="glyphicon glyphicon-play" style="margin-right: 5px"></span>添加资讯分类
		</h2>

		<form action="<%=basePath%>newsType/addNewsType" method="post" id="valForm">
			<div class="tablelist">
				<!-- 表单 -->
				<div class="row bdlist">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<p align="left">
									<input type="radio" name="pagetype" id="radio" value="列表"
										checked="checked" />列表 <input type="radio" name="pagetype"
										id="radio2" value="单页" /> 单页
								</p>
								<span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
