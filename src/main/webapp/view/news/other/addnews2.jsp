...
<body>
	...
	<div class="box-right-main">
		...
		<form action="<%=basePath%>news/addNews" method="post" id="valForm">
			<div class="tablelist">
				<!-- 表单 -->
				<div class="row bdlist">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="typeid.id" id="typeid.id"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="title"
									id="textfield" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="sort"
									id="textfield2" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="subtitle"
									id="textfield3" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="author"
									id="textfield4" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="source"
									id="textfield5" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="label"
									id="textfield6" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="clicknumber"
									id="textfield7" /> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
