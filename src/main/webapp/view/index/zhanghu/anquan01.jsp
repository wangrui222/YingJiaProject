                    ...
                    <div class="box" style="display:block">
                    	<table class="safeTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
	                            ...
	                            <c:if test="${members.memberIdentity==null&&members.names==null}">
	                           	 <td><a href="<%=basePath%>view/index/zhanghu/member_bankcard.jsp" class="renzheng">认证</a></td>
	                            </c:if>
	                            <c:if test="${members.memberIdentity!=null||members.names!=null}">
	                           	 <td>已认证</td>
	                            </c:if>
							...
							<tr>
									...
									<td>
									<c:if test="${memberBankcards.cardNo!=null}">
									已绑定
									</c:if>
									<c:if test="${memberBankcards.cardNo==null}">
									未绑定
									...
									<c:if test="${memberBankcards.cardNo==null}">
										<a href="<%=basePath%>view/index/zhanghu/member_bankcard.jsp" class="renzheng">查看</a>
									</c:if>
									</td>					 
				 ...
				 <div class="modal-body text-center"> 
					 <div class="form-horizontal" id="changeTelForm"> 
						 <div class="form-group" id="fullNameGroup"> 
							 ...
							 <div class="col-sm-5"> 
								 <div style="line-height:30px;text-align: left;">${members.mobilePhone}</div> 
							 </div> 
						 </div> 
...
<div id="changePWModal" class="modal fade infoModal" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content" style="border-radius: 0px;">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success" onclick="changeLoginPW();">1111提交</button>
				<button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">取消</button>
			</div>
		</div>
	</div>
