...
<body>
                   ...
                   <#list pageInfo.list as s>
                    <tr class="text-center">
                        ...
                        <td>元</td>
                        <td><span style="color: red;">${(s.interest)!!}</span>+
                        	<span style="color: red;">${(s.amount)!!}</span>=
                        	<span style="color: blue;"></span>元
                        </td>
                        <td><%-- ${(s.updateDate?string('yyyy-MM-dd HH:mm'))!!} --%></td>
                        <td>
                        ...
                        <td>
                        	<#if s.ispayment.description='未付款'>
                        	<span style="color: red;">${(s.ispayment.description)!!}</span>
                        	<#else>
                        	<span style="color: blue;">${(s.ispayment.description)!!}</span>
                        	</#if>
                        </td>
                        <td>
                        	<#if s.ispayment='ISPAYMENT'>
                        	<a href="${base}/sysmember/paymentPurchase?id=${s.id}" class="btn btn-primary btn-sm">立即还款</a>
                        	<#else>
        ...
        <@paginate currentPage=(pageInfo.pageNum)!0 totalPage=(pageInfo.pages)!0 actionUrl="${base}/sysmember/paymentContent" urlParas="&id=${(subject.id)!!}"/>
         </div>
