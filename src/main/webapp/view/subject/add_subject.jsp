				...
				<div class="row bdlist">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" name="status"> <#list
									status as statu> <#if statu_index<4>
									<option value="${statu}">${statu.description}</option> </#if>
									</#list>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" name="type"> <#list types
									as type> <#if type_has_next>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" name="safeguardWay">
									<#list safeGuardWays as way>
									<option value="${way}">${way.description}</option> </#list>
								</select> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						...
						<div class="form-group raiseStart" style="display: none;">
							...
							<div class="col-sm-9">
								<input name="raiseStart" class="form-control time"
									disabled="disabled" placeholder="请输入文本" type="text"> <span
									style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
			...
			<div class="col-md-12">
				...
				<form action="<%=basePath%>subject/sys/attchment"
					...
					<label class="control-label col-sm-3 ">图片预览</label> <input
						...
						name="files"> <input type="hidden" name="folderId">
				</form>
			</div>
		</div>
		<!-- 内容结束 -->
