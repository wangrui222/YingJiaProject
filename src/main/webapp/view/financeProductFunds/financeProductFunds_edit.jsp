    ...
    <form action="<%=basePath%>financeProductFunds/addFinanceProductFunds" method="post" id="valForm">
            ...
            <div class="row bdlist">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="floorAmount" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.floorAmount)!!}">
                            <span style="visibility: hidden">验证提示预留位置</span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="yearRate" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.yearRate)!!}">
                            <span style="visibility: hidden">验证提示预留位置</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="startDate" class="form-control time" placeholder="请输入文本" type="text" value="111"><!-- ${(financeProductFunds.startDate?string('yyyy-MM-dd'))!''} -->
                            <span style="visibility: hidden">验证提示预留位置</span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="endDate" class="form-control time" placeholder="请输入文本" type="text" value="11"><!--${(financeProductFunds.endDate?string('yyyy-MM-dd'))!''}  -->
                            <span style="visibility: hidden">验证提示预留位置</span>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="row bdlist">
            <div class="col-md-12">
                ...
                <div>
                    <div><textarea name="productTopic" id="productTopic" style="height: 300px;">${(financeProductFunds.productTopic)!!}</textarea></div>
         ...
         <div class="row bdlist">
            <div class="col-md-12">
                ...
                <div>
                    <div><textarea name="productFactor" id="productFactor" style="height: 300px;">${(financeProductFunds.productFactor)!!}</textarea></div>
      ...
      <div class="row bdlist productStrategy">
            <div class="col-md-12">
                ...
                <div>
                    <div><textarea name="productStrategy" id="productStrategy" style="height: 300px;">${(financeProductFunds.productStrategy)!!}</textarea></div>
        ...
        <div class="row bdlist product">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="productManagerName" id="productManagerName1" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.productManagerName)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="productManagerTitle" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.productManagerTitle)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="productManagerDesc" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.productManagerDesc)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div id="avatar" style="text-align:left">
                            ...
                            <input type="hidden" name="productManagerPic" id="productManagerPic" value="${(financeProductFunds.productManagerPic)!!}"/>
                            <div id="${(financeProductFunds.productManagerPic)!!}" class='uploadvedio'>
                             	<a href="<%=basePath%>${(financeProductFunds.productManagerPic)!!}" target='_black'>${(financeProductFunds.productManagerPic)!!}</a> 
                            	<a href=javascript:delimg('${(financeProductFunds.productManagerPic)!!}','filelink')>删除</a> 
                            </div>
                        </div>
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
        ...
        <div class="row bdlist productManager">
            <div class="col-md-12">
                ...
                <div>
                    <div><textarea name="productManager" id="productManager" style="height: 300px;">${(financeProductFunds.productManager)!!}</textarea></div>
        ...
        <div class="row bdlist">
            <div class="col-md-12">
                ...
                <div>
                    <div><textarea name="contract" id="contract" style="height: 300px;">${(financeProductFunds.contract)!!}</textarea></div>
        ...
        <div class="row bdlist">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="bankAccount" id="bankAccount" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.bankAccount)!!}">
        ...
        <div class="row bdlist guquan" style="display: none;">
            ...
            <div class="col-sm-6">
            	<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="productManagerName" id="productManagerName2" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.productManagerName)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="investPoints" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.investPoints)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="soldAmount" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.soldAmount)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="buyerCount" class="form-control" placeholder="请输入文本" type="text" value="${(financeProductFunds.buyerCount)!!}">
                        <span style="visibility: hidden">验证提示预留位置</span>
                    </div>
                </div>
            </div>
