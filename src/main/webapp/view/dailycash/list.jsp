...
<body>
                     ...
                     <div class="box-right-main">
                      ...
                      <div class="tablelist">
                      <form action="${base}/dailycash/list" method="post" id="form1">
                        <table class="table tabletop">
                        <tr>
                        <td style="width:110px;padding-left:30px">交易号：</td>
                        <td style="width:180px"><input type="text" class="form-control" name="tradeNo" value="${(tradeRecord.tradeNo)!!}" placeholder="交易号"></td>
                        <td style="width:110px;padding-left:30px">手机号：</td>
                        <td style="width:180px"><input type="text" class="form-control" name="member.mobilePhone" value="${(tradeRecord.member.mobilePhone)!!}" placeholder="手机号"></td>
                        ...
                        <td style="width:180px"><input type="text"  name="createDate" class="form-control time" placeholder="交易时间" readonly="readonly" value="dailycash/list.jsp"></td><!--${(tradeRecord.createDate?string('yyyy-MM-dd'))!!}  -->
                       ...
                       <#list pageInfo.list as mt>
                          <tr class="text-center">
                            ...
                            <td>
                            	<#if mt.tradeStatus!=2>
                            	<font style="color: red;">${(mt.statusDesc)!!}</font>
                            	<#else>
                            	<font style="color: green;">${(mt.statusDesc)!!}</font>
                            	</#if>
                            </td>
...
<@paginate currentPage=(pageInfo.pageNum)!0 totalPage=(pageInfo.pages)!0 actionUrl="${base}/dailycash/list" 
