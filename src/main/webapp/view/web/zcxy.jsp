...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<title>网站服务协议 - 盈+金融</title>
		<style>
			h1 {font-weight: bold; font-size: 16px; text-align: center; margin: 0; padding-bottom: 30px;}
			h2 {font-weight: bold; font-size: 14px; text-align: center; margin: 0; padding-top: 20px; text-align: left;}
			h3 {font-weight: normal; font-size: 14px; padding-top: 15px; text-align: left; margin: 0; padding-left: 45px;}
			p {padding-top: 15px; margin: 0; padding-left: 30px;}
			body {font: 14px/28px '微软雅黑', Arial, YaHei, tahoma, "Hiragino Sans GB", 宋体;}
			#agreement {
				width: 900px;
				padding: 30px;
				margin: auto;
	...
	<body>
		<div id="agreement">
			<div class="agr_warp">
				<h1>盈+金融网站服务协议</h1>
				<p>盈+金融是由杭州吉威投资管理有限公司负责运营（以下“本网站”均指盈+金融网站及杭州吉威投资管理有限公司）。在您注册成为本网站用户前请务必仔细阅读以下条款。若您一旦注册，则表示您同意接受本网站的服务并受以下条款的约束。若您不接受以下条款，请您立即停止注册或主动停止使用本网站的服务。</p>
				<h2>一、 本协议的签署和修订</h2>
				...
				<h3>1）您在本网站平台进行注册时将生成您账户，您账户将记载您在本网站平台的活动，上述您账户是您登陆本网站平台的唯一账户。</h3>
				<h3>2）您保证并承诺通过本网站平台进行交易的资金来源合法。</h3>
				<h3>3）您确认，您在本网站平台上按本网站服务流程所确认的交易状态，将成为本网站为您进行相关交易或操作（包括但不限于支付或收取款项、冻结资金、订立合同等）的不可撤销的指令。您同意相关指令的执行时间以本网站在本网站系统中进行实际操作的时间为准。您同意本网站有权依据本协议及/或本网站相关纠纷处理规则等约定对相关事项进行处理。您未能及时对交易状态进行修改、确认或未能提交相关申请所引起的任何纠纷或损失由您自行负责，本网站不承担任何责任。</h3>
				<h3>4）您了解本网站并不是银行或金融机构，按照中国法律规定，本网站不提供“即时”金额转账服务，您同意本网站对资金到账延迟不承担任何责任。</h3>
				...
				<h3>6）您每次使用本网站服务应直接登录本网站平台或使用本网站提供的链接登陆本网站平台（网址：盈+金融, 如本网站以公告等形式发布新的网址，请届时登陆新的网址），而不要通过邮件或其他网站提供的链接登录。您每次拨打本网站客户电话应拨打本网站官方网站提供的客服电话4000-999-158（如本网站以公告等形式发布新的客服电话，请届时拨打新的客服电话），而不要拨打其他任何电话。</h3>
				...
				<h3>2）您根据本协议以及本网站的相关规则签署电子合同后，不得擅自修改该合同。本网站向您提供电子合同的备案、查看、核对服务，如对电子合同真伪或电子合同的内容有任何疑问，您可通过使用本网站的“查阅合同”功能进行核对。如对此有任何争议，应以本网站记录的合同为准。</h3>
				...
				<h3>2）本网站通过您的用户账户及密码来识别您的指令，您确认，使用您账户和密码登陆后在本网站的一切行为均代表您本人。用户账户操作所产生的电子信息记录均为您行为的有效凭据，并由您本人承担由此产生的全部责任。</h3>
