            ...
            <td>
                <ul class="conInfoList">
                    <li class="info" style="height:auto">
                        <p>已购人数：<font color="#00baff">${(product.buyerCount)!!}人</font></p>
                        <p>管&nbsp;理&nbsp;&nbsp;人：<font color="#00baff">${(product.productManagerName)!!}</font></p>
                        <p>投资方向：<font color="#00baff">${(product.investPoints)!!} </font></p>
                    </li>
                </ul>
            </td>
        </tr>
