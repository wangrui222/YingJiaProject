                    	...
                    	<table class="safeTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
							...
							<#else> 
	                            ...
	                            <td></td>
	                            <td><p style="color:#888">保障账户安全，只有完成实名认证才能充值提款</p></td>
	                            <td><a href="${base}/account/security/memberBankcardView" class="renzheng">认证</a></td>
							</#if>   							                         
                          </tr>
							<tr>
								<#if whether> 
									...
									<td><a href="${base}/account/security/memberBankcardView" class="renzheng">查看</a></td>					 
								<#else>
									<td class="first"><span class="iconfont"><a href="#1">&#xe61c;</a><em>&#xe61b;</em></span></td>
									<td><p style="color:#ff503f">绑卡认证</p></td>
									<td></td>
...
<!--<script src="${base}/resources/web/js/security_realname.js"></script>-->
<!--<script src="${base}/resources/web/js/security_changemobile.js"></script>-->
<script src="${base}/resources/web/js/security_changeloginpwd.js"></script>
<script src="${base}/resources/web/js/security_withdrawpwd.js"></script>
</html>